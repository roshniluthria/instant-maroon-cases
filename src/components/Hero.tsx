...
const Hero = () => {
  return <section className="relative bg-white text-black overflow-hidden py-20">
      ...
      <div className="absolute -top-20 -right-20 w-64 h-64 rounded-full bg-maroon/10 blur-3xl"></div>
      <div className="absolute -bottom-32 -left-32 w-96 h-96 rounded-full bg-maroon-dark/10 blur-3xl"></div>
      <div className="absolute top-1/3 left-1/4 w-6 h-6 bg-maroon-light/40 rounded-full blur-sm float-effect"></div>
      <div className="absolute bottom-1/3 right-1/3 w-4 h-4 bg-maroon-light/40 rounded-full blur-sm float-effect"></div>
        ...
        <div className="max-w-3xl">
          <div className="rotate-3d">
            <div className="mb-2 inline-block px-4 py-2 bg-maroon/10 backdrop-blur-sm rounded-lg border border-maroon/20">
              <span className="text-maroon font-medium">Premium Phone Cases</span>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Button asChild variant="outline" size="lg" className="border-maroon text-maroon hover:bg-maroon/10 rotate-3d">
