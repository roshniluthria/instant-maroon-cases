...
const Hero = () => {
  return (
    <section className="relative bg-black text-white overflow-hidden py-20">
      ...
      <div className="absolute -bottom-32 -left-32 w-96 h-96 rounded-full bg-blue-700/10 blur-3xl"></div>
      <div className="absolute top-1/3 left-1/4 w-6 h-6 bg-blue-300/60 rounded-full blur-sm float-effect"></div>
      <div className="absolute bottom-1/3 right-1/3 w-4 h-4 bg-blue-200/60 rounded-full blur-sm float-effect"></div>
      
      <div className="container mx-auto px-4 py-24 md:py-32 relative z-10">
        <div className="max-w-3xl">
          <div className="rotate-3d">
            <div className="mb-2 inline-block px-4 py-2 bg-blue-500/10 backdrop-blur-sm rounded-lg border border-blue-500/20">
              <span className="text-blue-300 font-medium">Premium Phone Cases</span>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-4">
            <Button asChild size="lg" className="bg-blue-500 hover:bg-blue-600 text-white px-8 rotate-3d">
              <Link to="/products">
