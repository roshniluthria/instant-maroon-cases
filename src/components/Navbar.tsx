...
const Navbar = () => {
  ...
  return <header className="fixed w-full top-0 z-50 bg-white text-gray-800 shadow-md">
      ...
      {/* Mobile Navigation */}
      {isMenuOpen && <div className="md:hidden bg-white px-4 py-5 absolute top-16 left-0 w-full shadow-md">
          <nav className="flex flex-col gap-4">
            <Link to="/" className="font-medium hover:text-maroon transition-colors py-2" onClick={() => setIsMenuOpen(false)}>
              Home
            </Link>
            <Link to="/products" className="font-medium hover:text-maroon transition-colors py-2" onClick={() => setIsMenuOpen(false)}>
              Products
            </Link>
            <Link to="/contact" className="font-medium hover:text-maroon transition-colors py-2" onClick={() => setIsMenuOpen(false)}>
              Contact
            </Link>
